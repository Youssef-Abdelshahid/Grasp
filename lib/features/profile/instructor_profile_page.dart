...
class _InstructorProfilePageState extends State<InstructorProfilePage> {
  final _nameController = TextEditingController(text: 'Dr. Ahmed Ali');
  final _emailController = TextEditingController(text: 'ahmed.ali@university.edu');
  final _departmentController = TextEditingController(text: 'Computer Science');
  final _employeeIdController = TextEditingController(text: 'EMP-2024-001');
  final _bioController = TextEditingController(text: 'Associate Professor with 10+ years of experience in CS education and research.');
  ...
  static const _activities = [
    (
      ...
      label: 'Uploaded Lecture 5 slides',
      time: '2 hours ago'
    ),
    (
      icon: Icons.grading_rounded,
      color: AppColors.amber,
      label: 'Graded Midterm Exams',
      time: '5 hours ago'
    ),
    (
      icon: Icons.announcement_rounded,
      color: AppColors.cyan,
      label: 'Posted course announcement',
      time: 'Yesterday'
    ),
    (
      icon: Icons.people_rounded,
      color: AppColors.primary,
      label: 'Added 5 new students',
      time: '2 days ago'
    ),
  ];
