...
drop function if exists public.list_admin_quizzes(text, uuid, text, uuid);
  ...
  return coalesce((
    ...
    from (
      select jsonb_build_object(
          ...
          'course_code', c.code,
          'instructor_name', coalesce(instructor.full_name, 'Unknown instructor'),
          'title', q.title,
          ...
          'created_by_name', coalesce(creator.full_name, 'Unknown creator'),
